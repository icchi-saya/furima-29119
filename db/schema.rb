...
ActiveRecord::Schema.define(version: 2021_02_13_134124) do
  ...
  create_table "user_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_record_id"], name: "index_user_addresses_on_purchase_record_id"
  end
  ...
  add_foreign_key "user_addresses", "purchase_records"
end
